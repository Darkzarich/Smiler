...
const POST_MAX_TAG_LEN = 20;

const COMMENT_RATE_VALUE = 0.5;
const COMMENTS_INITIAL_COUNT = 10;
const COMMENTS_NESTED_LIMIT = 10;
const COMMENT_TIME_TO_UPDATE = 1000 * 60 * 10; // 10 min
const COMMENT_AUTO_HIDE_LEVEL = 3;

const USER_MAX_BIO_LENGTH = 300;
const USER_MAX_AVATAR_LENGTH = 150;
