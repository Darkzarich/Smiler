...
- **Aug 2026 — commit conventions** — The repo adopts **Conventional Commits** (the Angular flavour), validated on every commit by **[commitlint](https://github.com/conventional-changelog/commitlint)** in a new `commit-msg` hook, with commit scopes restricted to the workspace packages.
